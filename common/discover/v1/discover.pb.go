...
func (VisibilityRequest_Visibility) Descriptor() protoreflect.EnumDescriptor {
	return file_discover_v1_discover_proto_enumTypes[0].Descriptor()
}

func (VisibilityRequest_Visibility) Type() protoreflect.EnumType {
	return &file_discover_v1_discover_proto_enumTypes[0]
}
...
func (VisibilityRequest_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_discover_v1_discover_proto_rawDescGZIP(), []int{1, 0}
}
...
func (VisibilityResponse_Visibility) Descriptor() protoreflect.EnumDescriptor {
	return file_discover_v1_discover_proto_enumTypes[1].Descriptor()
}

func (VisibilityResponse_Visibility) Type() protoreflect.EnumType {
	return &file_discover_v1_discover_proto_enumTypes[1]
}
...
func (VisibilityResponse_Visibility) EnumDescriptor() ([]byte, []int) {
	return file_discover_v1_discover_proto_rawDescGZIP(), []int{2, 0}
}
...
type LobbyMessage struct {
	...
	Peer     *v1.Peer     `protobuf:"bytes,1,opt,name=peer,proto3" json:"peer,omitempty"`         // Users Peer Data
	Message  string       `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`   // Message to be published
	Metadata *v1.Metadata `protobuf:"bytes,3,opt,name=metadata,proto3" json:"metadata,omitempty"` // Metadata
}
...
func (x *LobbyMessage) GetPeer() *v1.Peer {
	if x != nil {
		return x.Peer
	}
	return nil
...
func (x *LobbyMessage) GetMetadata() *v1.Metadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type VisibilityRequest struct {
	...
	Visibility VisibilityRequest_Visibility `protobuf:"varint,3,opt,name=visibility,proto3,enum=common.discover.v1.VisibilityRequest_Visibility" json:"visibility,omitempty"` // Visibility
}
...
type VisibilityResponse struct {
	...
	Visibility VisibilityResponse_Visibility `protobuf:"varint,3,opt,name=visibility,proto3,enum=common.discover.v1.VisibilityResponse_Visibility" json:"visibility,omitempty"` // Visibility
}
...
var file_discover_v1_discover_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x69,
	0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31,
	0x1a, 0x0d, 0x76, 0x31, 0x2f, 0x69, 0x6e, 0x66, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22,
	0x7e, 0x0a, 0x0c, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12,
	...
	0x70, 0x65, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
	...
	0x8e, 0x02, 0x0a, 0x11, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52, 0x65,
	...
	0x52, 0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x50, 0x0a, 0x0a, 0x76,
	0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x30, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x56, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x52, 0x0a, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x22, 0x71, 0x0a,
	...
	,
	...
	0x45, 0x44, 0x10, 0x00, 0x12, 0x18, 0x0a, 0x14, 0x56, 0x49, 0x53, 0x49, 0x42, 0x49, 0x4c, 0x49,
	0x54, 0x59, 0x5f, 0x41, 0x56, 0x41, 0x49, 0x4c, 0x41, 0x42, 0x4c, 0x45, 0x10, 0x01, 0x12, 0x15,
	0x0a, 0x11, 0x56, 0x49, 0x53, 0x49, 0x42, 0x49, 0x4c, 0x49, 0x54, 0x59, 0x5f, 0x48, 0x49, 0x44,
	0x44, 0x45, 0x4e, 0x10, 0x02, 0x12, 0x16, 0x0a, 0x12, 0x56, 0x49, 0x53, 0x49, 0x42, 0x49, 0x4c,
	0x49, 0x54, 0x59, 0x5f, 0x46, 0x52, 0x49, 0x45, 0x4e, 0x44, 0x53, 0x10, 0x03, 0x42, 0x2c, 0x5a,
	...
	0x64, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_discover_v1_discover_proto_rawDescOnce sync.Once
	file_discover_v1_discover_proto_rawDescData = file_discover_v1_discover_proto_rawDesc
)

func file_discover_v1_discover_proto_rawDescGZIP() []byte {
	file_discover_v1_discover_proto_rawDescOnce.Do(func() {
		file_discover_v1_discover_proto_rawDescData = protoimpl.X.CompressGZIP(file_discover_v1_discover_proto_rawDescData)
	})
	return file_discover_v1_discover_proto_rawDescData
}

var file_discover_v1_discover_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_discover_v1_discover_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_discover_v1_discover_proto_goTypes = []interface{}{
	(VisibilityRequest_Visibility)(0),  // 0: common.discover.v1.VisibilityRequest.Visibility
	(VisibilityResponse_Visibility)(0), // 1: common.discover.v1.VisibilityResponse.Visibility
	(*LobbyMessage)(nil),               // 2: common.discover.v1.LobbyMessage
	(*VisibilityRequest)(nil),          // 3: common.discover.v1.VisibilityRequest
	(*VisibilityResponse)(nil),         // 4: common.discover.v1.VisibilityResponse
	(*v1.Peer)(nil),                    // 5: common.v1.Peer
	(*v1.Metadata)(nil),                // 6: common.v1.Metadata
}
var file_discover_v1_discover_proto_depIdxs = []int32{
	5, // 0: common.discover.v1.LobbyMessage.peer:type_name -> common.v1.Peer
	6, // 1: common.discover.v1.LobbyMessage.metadata:type_name -> common.v1.Metadata
	0, // 2: common.discover.v1.VisibilityRequest.visibility:type_name -> common.discover.v1.VisibilityRequest.Visibility
	1, // 3: common.discover.v1.VisibilityResponse.visibility:type_name -> common.discover.v1.VisibilityResponse.Visibility
...
func file_discover_v1_discover_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_discover_v1_discover_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_discover_v1_discover_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_discover_v1_discover_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_discover_v1_discover_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		...
		EnumInfos:         file_discover_v1_discover_proto_enumTypes,
		MessageInfos:      file_discover_v1_discover_proto_msgTypes,
	}.Build()
	File_discover_v1_discover_proto = out.File
	file_discover_v1_discover_proto_rawDesc = nil
