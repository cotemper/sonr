...
type Session struct {
	...
	Direction    v1.Direction   `protobuf:"varint,1,opt,name=direction,proto3,enum=common.v1.Direction" json:"direction,omitempty"`
...
func (x *Session) GetDirection() v1.Direction {
	if x != nil {
		return x.Direction
	}
...
func (x *Session) GetPayload() *v1.Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
type SessionItem struct {
	...
	Item      *v1.FileItem `protobuf:"bytes,3,opt,name=item,proto3" json:"item,omitempty"`
	...
	Direction v1.Direction `protobuf:"varint,7,opt,name=direction,proto3,enum=common.v1.Direction" json:"direction,omitempty"`
...
func (x *SessionItem) GetItem() *v1.FileItem {
	if x != nil {
		return x.Item
	}
	return nil
...
func (x *SessionItem) GetDirection() v1.Direction {
	if x != nil {
		return x.Direction
	}
	return v1.Direction(0)
...
type SessionPayload struct {
	...
	Direction v1.Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=common.v1.Direction" json:"direction,omitempty"`
}
...
func (x *SessionPayload) GetPayload() *v1.Payload {
	if x != nil {
		return x.Payload
	}
	return nil
...
func (x *SessionPayload) GetDirection() v1.Direction {
	if x != nil {
		return x.Direction
	}
	return v1.Direction(0)
...
var file_transmit_v1_transmit_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x01, 0x22, 0xf7, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x74, 0x65,
	...
	,
	...
	0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x22, 0x72, 0x0a, 0x0e, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x2c, 0x0a,
	...
	0x61, 0x64, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x32, 0x0a, 0x09, 0x64,
	0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14,
	0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x44, 0x69, 0x72, 0x65, 0x63,
	...
	0x6e, 0x72, 0x2d, 0x69, 0x6f, 0x2f, 0x73, 0x6f, 0x6e, 0x72, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x6d, 0x69, 0x74, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_transmit_v1_transmit_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_transmit_v1_transmit_proto_goTypes = []interface{}{
	(*Session)(nil),        // 0: common.transmit.v1.Session
	(*SessionItem)(nil),    // 1: common.transmit.v1.SessionItem
	(*SessionPayload)(nil), // 2: common.transmit.v1.SessionPayload
	nil,                    // 3: common.transmit.v1.Session.ResultsEntry
	(v1.Direction)(0),      // 4: common.v1.Direction
	(*v1.Peer)(nil),        // 5: common.v1.Peer
	(*v1.Payload)(nil),     // 6: common.v1.Payload
	(*v1.FileItem)(nil),    // 7: common.v1.FileItem
}
var file_transmit_v1_transmit_proto_depIdxs = []int32{
	4,  // 0: common.transmit.v1.Session.direction:type_name -> common.v1.Direction
	5,  // 1: common.transmit.v1.Session.from:type_name -> common.v1.Peer
	5,  // 2: common.transmit.v1.Session.to:type_name -> common.v1.Peer
	6,  // 3: common.transmit.v1.Session.payload:type_name -> common.v1.Payload
	1,  // 4: common.transmit.v1.Session.items:type_name -> common.transmit.v1.SessionItem
	3,  // 5: common.transmit.v1.Session.results:type_name -> common.transmit.v1.Session.ResultsEntry
	7,  // 6: common.transmit.v1.SessionItem.item:type_name -> common.v1.FileItem
	4,  // 7: common.transmit.v1.SessionItem.direction:type_name -> common.v1.Direction
	6,  // 8: common.transmit.v1.SessionPayload.payload:type_name -> common.v1.Payload
	4,  // 9: common.transmit.v1.SessionPayload.direction:type_name -> common.v1.Direction
