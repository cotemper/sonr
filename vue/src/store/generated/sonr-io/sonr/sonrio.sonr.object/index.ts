...
const getDefaultState = () => {
  return {
    ...
    _Structure: {
      ...
      ObjectFieldBlockchainAddress: getStructure(
        ObjectFieldBlockchainAddress.fromPartial({})
      ),
  ...
  actions: {
    ...
    async sendMsgDeleteObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgDeleteObject:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgDeleteObject:Send",
    ...
    async sendMsgReadObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgReadObject:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgReadObject:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async sendMsgCreateObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgCreateObject:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgCreateObject:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async sendMsgUpdateObject({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgUpdateObject:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgUpdateObject:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async MsgDeleteObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError(
            "TxClient:MsgDeleteObject:Create",
    ...
    async MsgCreateObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError(
            "TxClient:MsgCreateObject:Create",
            "Could not create message: " + e.message
          );
        }
      }
    ...
    async MsgUpdateObject({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError(
            "TxClient:MsgUpdateObject:Create",
            "Could not create message: " + e.message
          );
        }
      }
