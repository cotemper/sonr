  ...
  actions: {
    ...
    async sendMsgDownloadBlob({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgDownloadBlob:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgDownloadBlob:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async sendMsgDeleteBlob({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgDeleteBlob:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgDeleteBlob:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async sendMsgUploadBlob({ rootGetters }, { value, fee = [], memo = "" }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            "TxClient:MsgUploadBlob:Init",
            "Could not initialize signing client. Wallet is required."
          );
        } else {
          throw new SpVuexError(
            "TxClient:MsgUploadBlob:Send",
            "Could not broadcast Tx: " + e.message
          );
        }
      }
    ...
    async MsgDownloadBlob({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError(
            "TxClient:MsgDownloadBlob:Create",
            "Could not create message: " + e.message
          );
        }
      }
