...
(function (Connection) {
  Connection[(Connection["CONNECTION_UNSPECIFIED"] = 0)] =
    "CONNECTION_UNSPECIFIED";
  /** CONNECTION_WIFI - ConnectionWifi is used for WiFi connections. */
  Connection[(Connection["CONNECTION_WIFI"] = 1)] = "CONNECTION_WIFI";
  /** CONNECTION_ETHERNET - ConnectionEthernet is used for Ethernet connections. */
  Connection[(Connection["CONNECTION_ETHERNET"] = 2)] = "CONNECTION_ETHERNET";
  /** CONNECTION_MOBILE - ConnectionMobile is used for mobile connections. */
  Connection[(Connection["CONNECTION_MOBILE"] = 3)] = "CONNECTION_MOBILE";
  /** CONNECTION_OFFLINE - CONNECTION_OFFLINE */
  Connection[(Connection["CONNECTION_OFFLINE"] = 4)] = "CONNECTION_OFFLINE";
  Connection[(Connection["UNRECOGNIZED"] = -1)] = "UNRECOGNIZED";
})(Connection || (Connection = {}));
export function connectionFromJSON(object) {
  switch (object) {
    case 0:
...
export function connectionToJSON(object) {
  switch (object) {
...
/** Peers Active Status */
export var Peer_Status;
(function (Peer_Status) {
  /** STATUS_UNSPECIFIED - Offline - Not Online or Not a Full Node */
  Peer_Status[(Peer_Status["STATUS_UNSPECIFIED"] = 0)] = "STATUS_UNSPECIFIED";
  /** STATUS_ONLINE - Online - Full Node Available */
  Peer_Status[(Peer_Status["STATUS_ONLINE"] = 1)] = "STATUS_ONLINE";
  /** STATUS_AWAY - Away - Not Online, but has a full node */
  Peer_Status[(Peer_Status["STATUS_AWAY"] = 2)] = "STATUS_AWAY";
  /** STATUS_BUSY - Busy - Online, but busy with Transfer */
  Peer_Status[(Peer_Status["STATUS_BUSY"] = 3)] = "STATUS_BUSY";
  Peer_Status[(Peer_Status["UNRECOGNIZED"] = -1)] = "UNRECOGNIZED";
})(Peer_Status || (Peer_Status = {}));
export function peer_StatusFromJSON(object) {
  switch (object) {
    case 0:
...
export function peer_StatusToJSON(object) {
  switch (object) {
...
const baseLocation = { latitude: 0, longitude: 0, lastModified: 0 };
...
export const Location_Placemark = {
  ...
  decode(input, length) {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseLocation_Placemark };
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
const baseMetadata = { timestamp: 0, nodeId: "" };
...
const basePeer = { sName: "", status: 0, peerId: "", lastModified: 0 };
export const Peer = {
  encode(message, writer = Writer.create()) {
    if (message.sName !== "") {
