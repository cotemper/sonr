...
export type BucketMsgUpdateBucketResponse = object;
...
> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/sonrio/sonr/bucket/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BucketQueryParamsResponse, GooglerpcStatus>({
      path: `/sonrio/sonr/bucket/params`,
      method: "GET",
      format: "json",
      ...params,
    });
