...
const txClient = async (
  ...
  return {
    ...
    msgReadChannel: (data) => ({
      typeUrl: "/sonrio.sonr.channel.MsgReadChannel",
      value: MsgReadChannel.fromPartial(data),
    }),
    msgCreateChannel: (data) => ({
      typeUrl: "/sonrio.sonr.channel.MsgCreateChannel",
      value: MsgCreateChannel.fromPartial(data),
    }),
    msgDeleteChannel: (data) => ({
      typeUrl: "/sonrio.sonr.channel.MsgDeleteChannel",
      value: MsgDeleteChannel.fromPartial(data),
    }),
    msgUpdateChannel: (data) => ({
      typeUrl: "/sonrio.sonr.channel.MsgUpdateChannel",
      value: MsgUpdateChannel.fromPartial(data),
    }),
  };
};
