...
const txClient = async (
  ...
  return {
    ...
    msgAccessService: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgAccessService",
      value: MsgAccessService.fromPartial(data),
    }),
    msgRegisterName: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgRegisterName",
      value: MsgRegisterName.fromPartial(data),
    }),
    msgAccessName: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgAccessName",
      value: MsgAccessName.fromPartial(data),
    }),
    msgRegisterService: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgRegisterService",
      value: MsgRegisterService.fromPartial(data),
    }),
    msgUpdateService: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgUpdateService",
      value: MsgUpdateService.fromPartial(data),
    }),
    msgUpdateName: (data) => ({
      typeUrl: "/sonrio.sonr.registry.MsgUpdateName",
      value: MsgUpdateName.fromPartial(data),
    }),
  };
};
