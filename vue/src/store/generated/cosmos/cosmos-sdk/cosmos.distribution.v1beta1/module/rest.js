...
export class Api extends HttpClient {
  constructor() {
     ...
     */
    this.queryCommunityPool = (params = {}) =>
      this.request({
    ...
    /**
       ...
       */
    this.queryDelegationTotalRewards = (delegatorAddress, params = {}) =>
      this.request({
     ...
     */
    this.queryDelegatorValidators = (delegatorAddress, params = {}) =>
      this.request({
     ...
     */
    this.queryDelegatorWithdrawAddress = (delegatorAddress, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorCommission = (validatorAddress, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorOutstandingRewards = (validatorAddress, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorSlashes = (validatorAddress, query, params = {}) =>
      this.request({
