...
> extends HttpClient<SecurityDataType> {
  ...
  ) => Promise<HttpResponse<V1Beta1QueryCommunityPoolResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDelegationTotalRewards: (
    ...
    HttpResponse<V1Beta1QueryDelegationTotalRewardsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryDelegationRewards: (
    ...
    validatorAddress: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDelegationRewardsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDelegatorWithdrawAddress: (
    ...
    HttpResponse<V1Beta1QueryDelegatorWithdrawAddressResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryValidatorCommission: (
    ...
    HttpResponse<V1Beta1QueryValidatorCommissionResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryValidatorOutstandingRewards: (
    ...
    HttpResponse<V1Beta1QueryValidatorOutstandingRewardsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryValidatorSlashes: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryValidatorSlashesResponse, RpcStatus>>;
}
export {};
