...
> extends HttpClient<SecurityDataType> {
  ...
  ) => Promise<HttpResponse<V1Beta1QueryAllBalancesResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryBalance: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryBalanceResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDenomsMetadata: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDenomsMetadataResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDenomMetadata: (
    denom: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDenomMetadataResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryTotalSupply: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryTotalSupplyResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  querySupplyOf: (
    denom: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QuerySupplyOfResponse, RpcStatus>>;
}
export {};
