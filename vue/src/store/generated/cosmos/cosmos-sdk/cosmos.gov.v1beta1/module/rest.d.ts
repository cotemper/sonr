...
> extends HttpClient<SecurityDataType> {
  ...
  queryProposals: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryProposalsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryProposal: (
    proposalId: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryProposalResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDeposits: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDepositsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDeposit: (
    ...
    depositor: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDepositResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryTallyResult: (
    proposalId: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryTallyResultResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryVotes: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryVotesResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryVote: (
    ...
    voter: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryVoteResponse, RpcStatus>>;
}
export {};
