...
(function (V1Beta1ProposalStatus) {
  V1Beta1ProposalStatus["PROPOSAL_STATUS_UNSPECIFIED"] =
    "PROPOSAL_STATUS_UNSPECIFIED";
  V1Beta1ProposalStatus["PROPOSAL_STATUS_DEPOSIT_PERIOD"] =
    "PROPOSAL_STATUS_DEPOSIT_PERIOD";
  V1Beta1ProposalStatus["PROPOSAL_STATUS_VOTING_PERIOD"] =
    "PROPOSAL_STATUS_VOTING_PERIOD";
  V1Beta1ProposalStatus["PROPOSAL_STATUS_PASSED"] = "PROPOSAL_STATUS_PASSED";
  V1Beta1ProposalStatus["PROPOSAL_STATUS_REJECTED"] =
...
export class Api extends HttpClient {
  constructor() {
     ...
     */
    this.queryParams = (paramsType, params = {}) =>
      this.request({
     ...
     */
    this.queryProposals = (query, params = {}) =>
      this.request({
     ...
     */
    this.queryProposal = (proposalId, params = {}) =>
      this.request({
     ...
     */
    this.queryDeposits = (proposalId, query, params = {}) =>
      this.request({
     ...
     */
    this.queryDeposit = (proposalId, depositor, params = {}) =>
      this.request({
     ...
     */
    this.queryTallyResult = (proposalId, params = {}) =>
      this.request({
     ...
     */
    this.queryVotes = (proposalId, query, params = {}) =>
      this.request({
     ...
     */
    this.queryVote = (proposalId, voter, params = {}) =>
      this.request({
