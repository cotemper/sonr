...
(function (EvidenceType) {
  ...
  EvidenceType[(EvidenceType["LIGHT_CLIENT_ATTACK"] = 2)] =
    "LIGHT_CLIENT_ATTACK";
...
(function (ResponseOfferSnapshot_Result) {
  ...
  ResponseOfferSnapshot_Result[(ResponseOfferSnapshot_Result["UNKNOWN"] = 0)] =
    "UNKNOWN";
  /** ACCEPT - Snapshot accepted, apply chunks */
  ResponseOfferSnapshot_Result[(ResponseOfferSnapshot_Result["ACCEPT"] = 1)] =
    "ACCEPT";
  /** ABORT - Abort all snapshot restoration */
  ResponseOfferSnapshot_Result[(ResponseOfferSnapshot_Result["ABORT"] = 2)] =
    "ABORT";
  /** REJECT - Reject this specific snapshot, try others */
  ResponseOfferSnapshot_Result[(ResponseOfferSnapshot_Result["REJECT"] = 3)] =
    "REJECT";
  /** REJECT_FORMAT - Reject all snapshots of this format, try others */
  ResponseOfferSnapshot_Result[
    (ResponseOfferSnapshot_Result["REJECT_FORMAT"] = 4)
  ] = "REJECT_FORMAT";
  /** REJECT_SENDER - Reject all snapshots from the sender(s), try others */
  ResponseOfferSnapshot_Result[
    (ResponseOfferSnapshot_Result["REJECT_SENDER"] = 5)
  ] = "REJECT_SENDER";
  ResponseOfferSnapshot_Result[
    (ResponseOfferSnapshot_Result["UNRECOGNIZED"] = -1)
  ] = "UNRECOGNIZED";
...
(function (ResponseApplySnapshotChunk_Result) {
  ...
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["UNKNOWN"] = 0)
  ] = "UNKNOWN";
  /** ACCEPT - Chunk successfully accepted */
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["ACCEPT"] = 1)
  ] = "ACCEPT";
  /** ABORT - Abort all snapshot restoration */
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["ABORT"] = 2)
  ] = "ABORT";
  /** RETRY - Retry chunk (combine with refetch and reject) */
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["RETRY"] = 3)
  ] = "RETRY";
  /** RETRY_SNAPSHOT - Retry snapshot (combine with refetch and reject) */
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["RETRY_SNAPSHOT"] = 4)
  ] = "RETRY_SNAPSHOT";
  /** REJECT_SNAPSHOT - Reject this snapshot, try others */
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["REJECT_SNAPSHOT"] = 5)
  ] = "REJECT_SNAPSHOT";
  ResponseApplySnapshotChunk_Result[
    (ResponseApplySnapshotChunk_Result["UNRECOGNIZED"] = -1)
  ] = "UNRECOGNIZED";
})(
