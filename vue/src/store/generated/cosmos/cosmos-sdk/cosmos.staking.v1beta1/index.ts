  ...
  getters: {
    ...
    getValidatorUnbondingDelegations:
      ...
      (params = { params: {} }) => {
        ...
        return (
          state.ValidatorUnbondingDelegations[JSON.stringify(params)] ?? {}
        );
      },
    getDelegation:
      (state) =>
    ...
    getDelegatorUnbondingDelegations:
      ...
      (params = { params: {} }) => {
        ...
        return (
          state.DelegatorUnbondingDelegations[JSON.stringify(params)] ?? {}
        );
      },
    getRedelegations:
      (state) =>
  ...
  actions: {
      ...
      try {
        ...
        while (
          ...
          let next_values = (
            await queryClient.queryValidatorUnbondingDelegations(
              key.validator_addr,
              { ...query, "pagination.key": (<any>value).pagination.next_key }
            )
          ).data;
          value = mergeResults(value, next_values);
        }
    ...
    async QueryHistoricalInfo(
      ...
      try {
        ...
        return (
          getters["getHistoricalInfo"]({ params: { ...key }, query }) ?? {}
        );
      } catch (e) {
        throw new SpVuexError(
