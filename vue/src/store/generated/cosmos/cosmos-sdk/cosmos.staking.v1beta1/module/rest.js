...
export class Api extends HttpClient {
  constructor() {
     ...
     */
    this.queryDelegatorDelegations = (delegatorAddr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryRedelegations = (delegatorAddr, query, params = {}) =>
      this.request({
    ...
    /**
       ...
       */
    this.queryDelegatorUnbondingDelegations = (
      delegatorAddr,
      query,
      params = {}
    ) =>
    ...
    /**
       ...
       */
    this.queryDelegatorValidators = (delegatorAddr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryHistoricalInfo = (height, params = {}) =>
      this.request({
     ...
     */
    this.queryValidators = (query, params = {}) =>
      this.request({
     ...
     */
    this.queryValidator = (validatorAddr, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorDelegations = (validatorAddr, query, params = {}) =>
      this.request({
     ...
     */
    this.queryDelegation = (validatorAddr, delegatorAddr, params = {}) =>
      this.request({
     ...
     */
    this.queryValidatorUnbondingDelegations = (
      validatorAddr,
      query,
      params = {}
    ) =>
