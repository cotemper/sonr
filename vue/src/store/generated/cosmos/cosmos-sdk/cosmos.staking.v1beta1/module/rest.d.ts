...
> extends HttpClient<SecurityDataType> {
  ...
  queryDelegatorDelegations: (
    ...
    HttpResponse<V1Beta1QueryDelegatorDelegationsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryRedelegations: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryRedelegationsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDelegatorUnbondingDelegations: (
    ...
    HttpResponse<V1Beta1QueryDelegatorUnbondingDelegationsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryDelegatorValidators: (
    ...
    HttpResponse<V1Beta1QueryDelegatorValidatorsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryDelegatorValidator: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDelegatorValidatorResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryHistoricalInfo: (
    height: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryHistoricalInfoResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryParams: (
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryParamsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryPool: (
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryPoolResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryValidators: (
    ...
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryValidatorsResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryValidator: (
    validatorAddr: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryValidatorResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryValidatorDelegations: (
    ...
    HttpResponse<V1Beta1QueryValidatorDelegationsResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryDelegation: (
    ...
    delegatorAddr: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1Beta1QueryDelegationResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryUnbondingDelegation: (
    ...
    HttpResponse<V1Beta1QueryUnbondingDelegationResponse, RpcStatus>
  >;
  /**
   * No description
   *
  ...
  queryValidatorUnbondingDelegations: (
    ...
    HttpResponse<V1Beta1QueryValidatorUnbondingDelegationsResponse, RpcStatus>
  >;
}
export {};
