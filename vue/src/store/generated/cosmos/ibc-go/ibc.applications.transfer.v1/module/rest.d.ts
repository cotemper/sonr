...
> extends HttpClient<SecurityDataType> {
  ...
  ) => Promise<HttpResponse<V1QueryDenomTracesResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryDenomTrace: (
    hash: string,
    params?: RequestParams
  ) => Promise<HttpResponse<V1QueryDenomTraceResponse, RpcStatus>>;
  /**
   * No description
   *
   * @tags Query
  ...
  queryParams: (
    params?: RequestParams
  ) => Promise<HttpResponse<V1QueryParamsResponse, RpcStatus>>;
}
export {};
