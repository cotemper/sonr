...
export default {
  CosmosCosmosSdkCosmosAuthzV1Beta1: load(
  ...
  CosmosCosmosSdkCosmosFeegrantV1Beta1: load(
  ...
  CosmosIbcGoIbcApplicationsTransferV1: load(
    CosmosIbcGoIbcApplicationsTransferV1,
    "ibc.applications.transfer.v1"
  ),
  SonrIoSonrSonrioSonrBlob: load(SonrIoSonrSonrioSonrBlob, "sonrio.sonr.blob"),
  SonrIoSonrSonrioSonrBucket: load(
    SonrIoSonrSonrioSonrBucket,
    "sonrio.sonr.bucket"
  ),
  SonrIoSonrSonrioSonrChannel: load(
    SonrIoSonrSonrioSonrChannel,
    "sonrio.sonr.channel"
  ),
  SonrIoSonrSonrioSonrObject: load(
    SonrIoSonrSonrioSonrObject,
    "sonrio.sonr.object"
  ),
  SonrIoSonrSonrioSonrRegistry: load(
    SonrIoSonrSonrioSonrRegistry,
    "sonrio.sonr.registry"
  ),
};
